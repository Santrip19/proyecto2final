  ...
  .then(data => 
    {
        ...
        let gender = element.gender
         const persona = new Personaje(name, image, species, gender)
       
     document.getElementById("personajes").innerHTML = `
     <p style="text-align: center;">Nombre: ${persona.name}  <br> <br>
     <img style="display: block; margin: auto; height: 100px;" src="${persona.image}"
     <p style="text-align: center;">Genero: ${persona.gender}  
     <p style="text-align: center;">Especie: ${persona.species}  <br>
     ` ;
...
function Personaje (name, image, species, gender){
    this.name = name;
    this.image = image;
